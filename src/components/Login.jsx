...
const TRANSLATIONS = {
  ml: {
    ...
    placeholderEmail: 'ഇമെയിൽ (Email)...',
    placeholderPassword: 'പാസ്‌വേഡ് (Password)...',
  ...
  hi: {
    ...
    placeholderEmail: 'ईमेल (Email)...',
    placeholderPassword: 'पासवर्ड (Password)...',
  ...
  ta: {
    ...
    placeholderEmail: 'மின்னஞ்சல் (Email)...',
    placeholderPassword: 'கடவுச்சொல் (Password)...',
  ...
  es: {
    ...
    placeholderEmail: 'Correo (Email)...',
    placeholderPassword: 'Contraseña (Password)...',
